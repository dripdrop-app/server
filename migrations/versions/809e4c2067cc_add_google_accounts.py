...
def upgrade():
    ...
    op.add_column('music_jobs', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('NOW()'), nullable=True))
    op.drop_column('music_jobs', 'started')
    op.add_column('sessions', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('NOW()'), nullable=True))
    op.add_column('users', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('NOW()'), nullable=True))
...
def downgrade():
    ...
    op.add_column('music_jobs', sa.Column('started', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True))
