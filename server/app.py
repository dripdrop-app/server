...
from server.api import auth_api, music_api, youtube_api
...
app.router.include_router(auth_api.app.router, prefix='/auth')
app.router.include_router(music_api.app.router, prefix='/music')
app.router.include_router(youtube_api.app.router, prefix='/youtube')
