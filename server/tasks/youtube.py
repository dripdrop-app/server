...
from server.models.api import GoogleAccount, YoutubeChannel, YoutubeSubscription
...
class YoutubeTasker:
    ...
    @worker_task
    async def update_active_channels(self, db: DBSession = ...):
    ...
    @worker_task
    async def update_subscriptions(self, db: DBSession = ...):
